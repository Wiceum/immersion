                    ...
                    <div id="panel-1" class="panel">
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                ...
                                <!-- hidden input edit_user_id -->
                                <input hidden name="edit_user_id" value="<?=$edit_user_id?>"


                                <!-- username -->
                                <div class="form-group">
                                    <label class="form-label" for="simpleinput">Имя</label>
                                    <input type="text" id="simpleinput" class="form-control" value="<?=$user['name']?>" name="username">
                                </div>
